...
- **Python**: Ensure you have Python (version 3.10 or 3.11) installed on your system.
- ! Warning : The lastest version of Python 3.12 dosen't work with this Toolbox. You must have to download Python 3.11 from [python.org](https://www.python.org/downloads/) !
