...
- **Python**: Ensure you have Python (version 3.10 or 3.11) installed on your system. You can download it from [python.org](https://www.python.org/downloads/). !!!WARNING!!! the toolbox will not work if you had installed python 3.12, make sure you installed Python 3.10 or 3.11.
