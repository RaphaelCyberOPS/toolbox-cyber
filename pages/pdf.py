...
class PDFPage(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        generate_button = ctk.CTkButton(self.canvas, text="Generate Report", fg_color="#041B29", hover_color="#083247", command=self.generate_pdf)
    ...
    def perform_pdf_generation(self, json_path):
        ...
        try:
            ...
            # First page
            cover_title = "Pentest Toolbox Report by HackMeRaphaël"
            ...
            summary = (
                ...
                "Please make some importance to this report !"
            )
